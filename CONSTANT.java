public class CONSTANT {
    ...
    protected final String WRONG_ARGUMENTS_MESSEGE = "The argument you passed is Wrong . So give an valid argiment to the main class ";
    protected final String WORD_MESSEGE = " word(s) found ";
